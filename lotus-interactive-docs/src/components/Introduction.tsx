    ...
    <div className="space-y-8">
      ...
      <div className="bg-lotus-grey-900 rounded p-6 border border-lotus-grey-700">
        ...
        <ul className="space-y-4">
          <li className="flex items-start gap-3">
            <div className="w-8 h-8 bg-lotus-purple-900/50 rounded flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="bg-lotus-grey-800 rounded p-6 border border-lotus-grey-700">
        <div className="flex items-start gap-3">
          <div className="w-9 h-9 bg-lotus-purple-900/50 rounded flex items-center justify-center flex-shrink-0 mt-0.5">
            <svg className="w-5 h-5 text-lotus-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
