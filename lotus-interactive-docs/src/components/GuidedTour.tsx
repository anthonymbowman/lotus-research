...
export function GuidedTour({ onComplete }: GuidedTourProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="guided-tour-title">
      ...
      <div
        ref={modalRef}
        className="relative bg-lotus-grey-800 border border-lotus-grey-700 rounded p-8 max-w-md w-full mx-4 shadow-lotus-lg animate-slideIn focus:outline-none"
        tabIndex={-1}
      >
        {/* Progress dots */}
        ...
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-lotus-purple-900/50 border border-lotus-purple-500 rounded flex items-center justify-center">
            {currentStep === 0 && (
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={handleNext}
            className="px-6 py-2.5 bg-lotus-purple-500 hover:bg-lotus-purple-600 text-white font-medium rounded transition-colors flex items-center gap-2"
          >
