      ...
      >
        ...
        <div className="bg-lotus-grey-900 rounded p-6 border border-lotus-grey-700">
          <div className="flex flex-col items-center gap-6 max-w-lg mx-auto">
            ...
            <div className="w-full bg-lotus-purple-900/30 border-2 border-lotus-purple-600 rounded p-5 text-center">
            ...
            <div className="w-full bg-rating-b/10 border-2 border-rating-b rounded p-5 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
