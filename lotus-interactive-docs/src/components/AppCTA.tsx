...
export function AppCTA({ context, heading, description }: AppCTAProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-lotus-purple-900/40 to-lotus-purple-800/20 rounded p-6 border border-lotus-purple-700/50">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a
          ...
          onClick={handleClick}
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-lotus-purple-600 hover:bg-lotus-purple-500 rounded text-white font-medium transition-colors"
        >
