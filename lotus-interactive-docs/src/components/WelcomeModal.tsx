...
export function WelcomeModal({ onStartTour, onSkip }: WelcomeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="welcome-title">
      ...
      <div
        ref={modalRef}
        className="relative bg-lotus-grey-800 border border-lotus-grey-700 rounded max-w-lg w-full mx-4 shadow-lotus-lg animate-slideIn overflow-hidden focus:outline-none"
        tabIndex={-1}
      >
        {/* Gradient header */}
        ...
        <div className="p-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-lotus-purple-900/50 border border-lotus-purple-500/50 rounded flex items-center justify-center">
          ...
          <div className="text-center mb-8">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-3 bg-lotus-grey-900 rounded">
          ...
          <div className="space-y-3">
            <button
              onClick={onStartTour}
              className="w-full px-6 py-3 bg-lotus-purple-500 hover:bg-lotus-purple-600 text-white font-medium rounded transition-colors flex items-center justify-center gap-2"
            >
              Take the Tour
