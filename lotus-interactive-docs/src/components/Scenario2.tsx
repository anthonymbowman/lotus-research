    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-lotus-grey-800/50 rounded p-4 border border-lotus-grey-700">
            <h3 className="text-sm font-medium text-lotus-grey-300 mb-3">Kink Curve Constants</h3>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-lotus-grey-400">Target utilization:</span>
                <span className="ml-2 font-mono">90%</span>
              </div>
              <div>
                <span className="text-lotus-grey-400">At u=0:</span>
                <span className="ml-2 font-mono">0.25×</span>
              </div>
              <div>
                <span className="text-lotus-grey-400">At u=90%:</span>
                <span className="ml-2 font-mono">1×</span>
              </div>
              <div>
                <span className="text-lotus-grey-400">At u=100%:</span>
          ...
          {/* Derived values */}
          <div className="bg-lotus-grey-800 rounded p-4 border border-lotus-grey-700">
            <h3 className="text-sm font-medium text-lotus-grey-300 mb-3">Current Spread</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-lotus-grey-300">S90 (spread at 90%):</span>
                <span className="font-mono">{formatPercent(result.spread90)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-lotus-grey-300">S(u) (current spread):</span>
      ...
      {/* Output Table */}
      <div className="bg-lotus-grey-800 rounded p-4 border border-lotus-grey-700">
        <h3 className="text-sm font-medium text-lotus-grey-300 mb-4">Comparison at u = {formatPercent(utilization)}</h3>
        <OutputTable
          rows={[
            {
              label: 'Borrow Rate',
      ...
      {/* Deviation metrics */}
      <div className="bg-lotus-grey-800 rounded p-4 border border-lotus-grey-700">
        <h3 className="text-sm font-medium text-lotus-grey-300 mb-4">Deviation from Target (90% utilization)</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-3 bg-lotus-grey-900/60 rounded">
            <h4 className="text-xs font-medium text-lotus-grey-400 uppercase mb-2">Borrow Rate Deviation</h4>
            <div className="flex justify-between items-center">
              <span className="text-sm text-lotus-grey-200">With PD:</span>
              <span className={`font-mono text-sm ${Math.abs(result.borrowDeviationPD ?? 0) < Math.abs(result.borrowDeviationNoPD ?? 0) ? 'text-rating-a' : 'text-lotus-grey-100'}`}>
                {formatDeviation(result.borrowDeviationPD)}
              </span>
            </div>
            <div className="flex justify-between items-center mt-1">
              <span className="text-sm text-lotus-grey-200">Without PD:</span>
              <span className="font-mono text-sm text-lotus-grey-100">
          ...
          <div className="p-3 bg-lotus-grey-900/60 rounded">
            <h4 className="text-xs font-medium text-lotus-grey-400 uppercase mb-2">Supply Rate Deviation</h4>
            <div className="flex justify-between items-center">
              <span className="text-sm text-lotus-grey-200">With PD:</span>
              <span className={`font-mono text-sm ${Math.abs(result.supplyDeviationPD ?? 0) < Math.abs(result.supplyDeviationNoPD ?? 0) ? 'text-rating-a' : 'text-lotus-grey-100'}`}>
      ...
      <details className="bg-lotus-grey-800/50 rounded border border-lotus-grey-700">
        ...
        <div className="px-4 pb-4 text-sm text-lotus-grey-300 font-mono space-y-2">
          ...
          <hr className="my-2 border-lotus-grey-600" />
