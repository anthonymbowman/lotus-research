...
export function Vaults({ tranches, productiveDebtRate }: VaultsProps) {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        whatYoullLearn={vContent.pageHeader.whatYoullLearn}
      ...
      <div className="bg-lotus-grey-800 rounded-lg p-6 border border-lotus-grey-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {vContent.howVaultsWork.steps.map((step, i) => (
            <div key={i} className="bg-lotus-grey-700/50 rounded-lg p-4 border border-lotus-grey-600">
          ...
          <div className="flex flex-col items-center gap-6 max-w-lg mx-auto">
            ...
            <div className="w-full bg-blue-900/30 border-2 border-blue-600 rounded-xl p-5 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-lg font-semibold text-blue-300">{vContent.howVaultsWork.flowDiagram.userDeposit}</span>
              </div>
              <p className="text-sm text-blue-200/70">{vContent.howVaultsWork.flowDiagram.autoConverted}</p>
            </div>
      ...
      {/* Strategy Selector */}
      <div className="bg-lotus-grey-800 rounded-lg p-6 border border-lotus-grey-700">
        <h3 className="text-lg font-medium text-lotus-grey-100 mb-4">{vContent.strategies.heading}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="bg-emerald-900/20 rounded-xl p-5 border border-emerald-700/50">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <div className="text-sm text-emerald-400">{vContent.expectedApyLabel}</div>
